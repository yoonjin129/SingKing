// front-end/src/PrecisionTraining.js
...
const PrecisionTraining = () => {
  ...
  // 목적지 페이지가 기대하는 형태(song 객체)와
  // 기존 형태(songTitle/artist/imagePath)를 모두 전달
  const handleSongClick = (songTitle, artist, imagePath) => {
    const song = { recommend: songTitle, artist, image: imagePath };
    navigate("/immediate_feedback_analyze", {
      state: {
        song, // ✅ ToneDiagnosticsResult와 동일 포맷
        songTitle, // ✅ 구버전 호환
        artist,
        imagePath,
      },
          ...
          <div className="ai_training">
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    "안아줘",
                    "정준일",
                    "./img/songs/cover_hug.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_hug.png"
                  alt="안아줘"
                />
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    "너였다면",
                    "정승환",
                    "./img/songs/cover_if_it_is_you.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_if_it_is_you.png"
                  alt="너였다면"
                />
                <div className="ai_text">
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    ...
                    "장범준",
                    "./img/songs/cover_wobbly_flowers.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_wobbly_flowers.png"
                  alt="흔들리는 꽃들 속에서 네 샴푸 향이 느껴진 거야"
                />
                <div className="ai_text">
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    "기억해줘요 내 모든 날과 그때를",
                    "거미",
                    "./img/songs/cover_remember.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_remember.png"
                  alt="기억해줘요 내 모든 날과 그때를"
                />
                <div className="ai_text">
                  <p className="ai_text_1">기억해줘요 내 모든 날과 그때를</p>
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    "아모르 파티",
                    "김연자",
                    "./img/songs/cover_amo.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_amo.png"
                  alt="아모르 파티"
                />
                <div className="ai_text">
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    "사랑, 결코 시들지 않는",
                    "서문탁",
                    "./img/songs/cover_love_never.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_love_never.png"
                  alt="사랑, 결코 시들지 않는"
                />
                <div className="ai_text">
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    "밤편지",
                    "아이유",
                    "./img/songs/cover_letter_at_night.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_letter_at_night.png"
                  alt="밤편지"
                />
                <div className="ai_text">
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    "Supernova",
                    "에스파",
                    "./img/songs/cover_supernova.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_supernova.png"
                  alt="Supernova"
                />
                <div className="ai_text">
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    "사랑은 늘 도망가",
                    "임영웅",
                    "./img/songs/cover_love_run.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_love_run.png"
                  alt="사랑은 늘 도망가"
                />
                <div className="ai_text">
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    "야생화",
                    "박효신",
                    "./img/songs/cover_wild_flower.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_wild_flower.png"
                  alt="야생화"
                />
                <div className="ai_text">
              ...
              <div
                ...
                onClick={() =>
                  handleSongClick(
                    "흰수염고래",
                    "YB",
                    "./img/songs/cover_a_blue_whale.png"
                  )
                }
              >
                <img
                  className="ai_diagnosis_img"
                  src="./img/songs/cover_a_blue_whale.png"
                  alt="흰수염고래"
                />
                <div className="ai_text">
            ...
            <div className="drag_menu_component drag_menu_component_ai">
              ...
              <div className="drag_menu_component_1 drag_menu_component_1_short">
                <img
                  className="ai_precise_img"
                  src="./img/singers/cover_jung_seung_hwan.png"
                  alt="정승환"
                />
                <div className="ai_text">
              ...
              <div className="drag_menu_component_1 drag_menu_component_1_short">
                <img
                  className="ai_precise_img"
                  src="./img/singers/cover_Jung_Joon_il.png"
                  alt="정준일"
                />
                <div className="ai_text">
